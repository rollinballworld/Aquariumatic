...
class TankHandler(tornado.web.RequestHandler):
    ...
    def post(self, input):
        ...
        if WebCommand == 'Heating':
            ...
            update_response['TempValue'] = str(aquarium.CurrentReading('Temp'))
            update_response['pHValue'] = str(aquarium.CurrentReading('pH'))
            update_response['LightValue'] = str(aquarium.CurrentReading('Light'))
            update_response['PumpValue'] = str(aquarium.CurrentReading('Pump'))
